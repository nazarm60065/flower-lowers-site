...
$usePriceInAdditionalColumn = false && in_array('PRICE', $arParams['COLUMNS_LIST']) && $arParams['PRICE_DISPLAY_MODE'] === 'Y';
		...
		{{^SHOW_RESTORE}}
            ...
            ?>
				<div class="basket-items-list-item-descriptions-inner" id="basket-item-height-aligner-{{ID}}">
                    ...
                    {
                        ?>
                        <div class="basket-items-list-item-sum basket-items-list-item-price<?=(!isset($mobileColumns['SUM']) ? ' hidden-xs' : '')?>">
            ...
            {{/DELAYED}}
            {{#WARNINGS.length}}
            <div class="basket-items-list-item-note" data-entity="basket-item-warning-node">
