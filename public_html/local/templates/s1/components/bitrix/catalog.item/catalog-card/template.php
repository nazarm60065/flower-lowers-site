...
if (isset($arResult['ITEM'])) {
    ...
    if ($arParams['ADDITIONAL_CSS_CLASS']) {
        $additionalCssClass[] = $arParams['ADDITIONAL_CSS_CLASS'];
    }

    if ($item['PREVIEW_PICTURE_SECOND'] && $item['PREVIEW_PICTURE']['SRC'] !== $item['PREVIEW_PICTURE_SECOND']['SRC']) {
    ...
    <div class="catalog-card<?= $additionalCssClass ?>" id="<?= $areaId ?>"
         data-entity="item"<?= $item['tabs'] ? (' data-tab="' . $item['tabs'] . '"') : "" ?>>
        <?
